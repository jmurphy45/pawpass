<template>
  <PortalLayout>
    <div class="space-y-6">
      ...
      <div v-if="dogs.length === 0" class="card p-12 text-center border-dashed">
        ...
        <Link :href="route('portal.dogs.create')" class="btn-primary mt-4 inline-flex">
          Add your first dog
        </Link>
      </div>
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link
          ...
          class="block card overflow-hidden hover:-translate-y-0.5 hover:shadow-card-md transition-all duration-200"
        >
          <!-- Gradient header -->
          <div
